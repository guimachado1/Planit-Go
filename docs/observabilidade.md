...
| API respondendo | [Health check](https://pl-ff991c3a68c443babd649f987729d590.ecs.sa-east-1.on.aws/health) → `{ "ok": true, "service": "planit-go-api" }` | — |
...
https://pl-ff991c3a68c443babd649f987729d590.ecs.sa-east-1.on.aws/health
